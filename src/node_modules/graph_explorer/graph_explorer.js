...
async function component (opts, protocol) {
  ...
  ******************************************************************************/
  function create_node(entry) {
    ...
    let prefix = create_tree_prefix(depth, is_expanded, has_children)
    
    node.className = 'explorer-node'
    node.dataset.path = entry_path
    node.dataset.index = entry_path
    node.style.paddingLeft = `${17 + depth * 8.25}px`
  ...
  /******************************************************************************/
  function create_tree_prefix(depth, is_expanded, has_children) {
